...
if ( `pwd` != "/home/ecegrid/a/595m04/shraddha/Personal/new_protocompiler/memory_original_25_03_24/rom_bdoor_demo_package" ) then
  echo "Warning: Working directory is changed."
  echo "Executing the postelab script in the same working directory is recommended."
  echo "    Previous path: /home/ecegrid/a/595m04/shraddha/Personal/new_protocompiler/memory_original_25_03_24/rom_bdoor_demo_package"
  echo "    Current path: `pwd`"
  echo ""
endif

cd /home/ecegrid/a/595m04/shraddha/Personal/new_protocompiler/memory_original_25_03_24/rom_bdoor_demo_package
