...
if ( `pwd` != "/home/ecegrid/a/595m04/shraddha/Personal/new_protocompiler/mia_mod_2/mia" ) then
  echo "Warning: Working directory is changed."
  echo "Executing the postelab script in the same working directory is recommended."
  echo "    Previous path: /home/ecegrid/a/595m04/shraddha/Personal/new_protocompiler/mia_mod_2/mia"
  echo "    Current path: `pwd`"
  echo ""
endif

cd /home/ecegrid/a/595m04/shraddha/Personal/new_protocompiler/mia_mod_2/mia
