...
set rompram_rd9 {rom_demo_sp.dout9[31:0]}
set rompram_rd10 {rom_demo_sp.dout10[31:0]}
set rompram_rd11 {rom_demo_sp.dout11[31:0]} 
set rompram_rd12 {rom_demo_sp.dout12[31:0]} 
set rompram_rd13 {rom_demo_sp.dout13[31:0]}
set rompram_rd14 {rom_demo_sp.dout14[31:0]}
set rompram_rd15 {rom_demo_sp.dout15[31:0]} 
set rompram_rd16 {rom_demo_sp.dout16[31:0]}
#
...
set rompram_ra9 {rom_demo_sp.addr9[7:0]}
set rompram_ra10 {rom_demo_sp.addr10[7:0]} 
set rompram_ra11 {rom_demo_sp.addr11[7:0]} 
set rompram_ra12 {rom_demo_sp.addr12[7:0]}
set rompram_ra13 {rom_demo_sp.addr13[7:0]}
set rompram_ra14 {rom_demo_sp.addr14[7:0]} 
set rompram_ra15 {rom_demo_sp.addr15[7:0]} 
set rompram_ra16 {rom_demo_sp.addr16[7:0]}
...
set rompram_read_a17 {rom_demo_sp.m1.a17[15:0]} 
set rompram_read_a18 {rom_demo_sp.m1.a18[15:0]} 
set rompram_read_a19 {rom_demo_sp.m1.a19[15:0]} 
set rompram_read_a20 {rom_demo_sp.m1.a20[15:0]} 
set rompram_read_a21 {rom_demo_sp.m1.a21[15:0]}
set rompram_read_a22 {rom_demo_sp.m1.a22[15:0]} 
set rompram_read_a23 {rom_demo_sp.m1.a23[15:0]} 
set rompram_read_a24 {rom_demo_sp.m1.a24[15:0]} 
set rompram_read_a25 {rom_demo_sp.m1.a25[15:0]} 
set rompram_read_a26 {rom_demo_sp.m1.a26[15:0]} 
set rompram_read_a27 {rom_demo_sp.m1.a27[15:0]} 
set rompram_read_a28 {rom_demo_sp.m1.a28[15:0]} 
set rompram_read_a29 {rom_demo_sp.m1.a29[15:0]}
set rompram_read_a30 {rom_demo_sp.m1.a30[15:0]} 
set rompram_read_a31 {rom_demo_sp.m1.a31[15:0]} 
set rompram_read_a32 {rom_demo_sp.m1.a32[15:0]}
 
set rompram_read_output_of_add {rom_demo_sp.output_of_add[15:0]}
set rompram_read_output_of_add_16 {rom_demo_sp.output_of_add_16[255:0]}
...
proc read_dut_values {expected_data} {
  ...
  for {set ii 0} {$ii <= 255} {incr ii 16} {
    ...
    set output_1 {rom_demo_sp.output_of_add_16[255:240]}
    set output [value $output_1]

    set read_a1 [value $rompram_read_a1]
    set read_a2 [value $rompram_read_a2]
    puts "Matrix1\[1\]: $read_a1 ,   Matrix2\[1\]: $read_a2 ,   Output: $output"

    set output_2 {rom_demo_sp.output_of_add_16[239:224]}
    set output [value $output_2]

    set read_a3 [value $rompram_read_a3]
    set read_a4 [value $rompram_read_a4]
    puts "Matrix1\[2\]: $read_a3 ,   Matrix2\[2\]: $read_a4 ,   Output: $output"

    set output_3 {rom_demo_sp.output_of_add_16[223:208]}
    set output [value $output_3]

    set read_a5 [value $rompram_read_a5]
    set read_a6 [value $rompram_read_a6]
    puts "Matrix1\[3\]: $read_a5 ,   Matrix2\[3\]: $read_a6 ,   Output: $output"

    set output_4 {rom_demo_sp.output_of_add_16[207:192]}
    set output [value $output_4]

    set read_a7 [value $rompram_read_a7]
    set read_a8 [value $rompram_read_a8]
    puts "Matrix1\[4\]: $read_a7 ,   Matrix2\[4\]: $read_a8 ,   Output: $output"

    set output_5 {rom_demo_sp.output_of_add_16[191:176]}
    set output [value $output_5]

    set read_a9 [value $rompram_read_a9]
    set read_a10 [value $rompram_read_a10]
    puts "Matrix1\[5\]: $read_a9 ,   Matrix2\[5\]: $read_a10 ,   Output: $output"

    set output_6 {rom_demo_sp.output_of_add_16[175:160]}
    ...
    set output_7 {rom_demo_sp.output_of_add_16[159:144]}
    set output [value $output_7]

    set read_a13 [value $rompram_read_a13]
    set read_a14 [value $rompram_read_a14]
    puts "Matrix1\[7\]: $read_a13 ,   Matrix2\[7\]: $read_a14 ,   Output: $output"

    set output_8 {rom_demo_sp.output_of_add_16[143:128]}
    ...
    set output_9 {rom_demo_sp.output_of_add_16[127:112]}
    set output [value $output_9]

    set read_a17 [value $rompram_read_a17]
    set read_a18 [value $rompram_read_a18]
    puts "Matrix1\[9\]: $read_a17 ,   Matrix2\[9\]: $read_a18 ,   Output: $output"

    set output_10 {rom_demo_sp.output_of_add_16[111:96]}
    ...
    set output_11 {rom_demo_sp.output_of_add_16[95:80]}
    set output [value $output_11]

    set read_a21 [value $rompram_read_a21]
    set read_a22 [value $rompram_read_a22]
    puts "Matrix1\[11\]: $read_a21 ,   Matrix2\[11\]: $read_a22 ,   Output: $output"

    set output_12 {rom_demo_sp.output_of_add_16[79:64]}
    ...
    set output_13 {rom_demo_sp.output_of_add_16[63:48]}
    set output [value $output_13]

    set read_a25 [value $rompram_read_a25]
    set read_a26 [value $rompram_read_a26]
    puts "Matrix1\[13\]: $read_a25 ,   Matrix2\[13\]: $read_a26 ,   Output: $output"

    set output_14 {rom_demo_sp.output_of_add_16[47:32]}
    ...
    set output_15 {rom_demo_sp.output_of_add_16[31:16]}
    set output [value $output_15]

    set read_a29 [value $rompram_read_a29]
    set read_a30 [value $rompram_read_a30]
    puts "Matrix1\[15\]: $read_a29 ,   Matrix2\[15\]: $read_a30 ,   Output: $output"

    set output_16 {rom_demo_sp.output_of_add_16[15:0]}
    set output [value $output_16]

    set read_a31 [value $rompram_read_a31]
    set read_a32 [value $rompram_read_a32]
    puts "Matrix1\[16\]: $read_a31 ,   Matrix2\[16\]: $read_a32 ,   Output: $output"
...
lappend data "110DADD1"
lappend data "210DDA45"
lappend data "310D6464"
lappend data "410D4543"
lappend data "510D6464"
lappend data "610D5765"
lappend data "710D55D2"
lappend data "810D1234"
lappend data "910D3456"
lappend data "A10D5323"
lappend data "B10D4356"
lappend data "C10D4324"
lappend data "D10D5353"
lappend data "E10D3344"
lappend data "F10D3234"
lappend data "020D5345"
lappend data "120D3556"
lappend data "220D3432"
lappend data "320D4324"
lappend data "420D5354"
lappend data "520D6443"
lappend data "620D2355"
lappend data "720D4435"
lappend data "820D3456"
lappend data "920D3532"
lappend data "A20D2353"
lappend data "B20D3535"
lappend data "C20D3526"
lappend data "D20D6767"
lappend data "E20D4645"
lappend data "F20D6554"
lappend data "030D3356"
lappend data "130D5665"
lappend data "230D6767"
lappend data "330D455A"
lappend data "430D4245"
lappend data "530D6575"
lappend data "630D2345"
lappend data "730D9808"
lappend data "830D787E"
lappend data "930D7898"
lappend data "A30D0788"
lappend data "B30D0000"
lappend data "C30D6762"
lappend data "D30D4354"
lappend data "50003ff0"
lappend data "5000100D"
lappend data "5000200D"
lappend data "300D4ABC"
