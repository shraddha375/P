...
///*
         (* haps_force *) $dumpvars (1, rom_demo_sp.addr9); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.addr10); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.addr11); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.addr12); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.addr13); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.addr14); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.addr15); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.addr16); //-------
//*/
...
///*
	 (* haps_force *) $dumpvars (1, rom_demo_sp.dout9);
         (* haps_force *) $dumpvars (1, rom_demo_sp.dout10); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.dout11); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.dout12); //-------
	 (* haps_force *) $dumpvars (1, rom_demo_sp.dout13);
         (* haps_force *) $dumpvars (1, rom_demo_sp.dout14); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.dout15); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.dout16); //-------
//*/
	 (* haps_force *) $dumpvars (1, rom_demo_sp.dout1_prev);
         ...
         (* haps_force *) $dumpvars (1, rom_demo_sp.m1.a17); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.m1.a18); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.m1.a19); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.m1.a20); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.m1.a21); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.m1.a22); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.m1.a23); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.m1.a24); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.m1.a25); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.m1.a26); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.m1.a27); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.m1.a28); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.m1.a29); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.m1.a30); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.m1.a31); //-------
         (* haps_force *) $dumpvars (1, rom_demo_sp.m1.a32); //-------
/*
...
*/
         ...
         (* haps_force *) $dumpvars (1, rom_demo_sp.output_of_add_16);  //-------
