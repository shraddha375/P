...
proc read_dut_values {expected_data} {
  ...
  #set read_a [value $rompram_read_a]
  #puts "a: $read_a"
  #set read_b [value $rompram_read_b]
  #puts "b: $read_b"
  #set read_c [value $rompram_read_c]
  #puts "c: $read_c"
  #
  ...
  set read_rom [value $rompram_read_rom]
  # Print out read result--------new
  #puts "rom: $read_rom"
  #force -release $rompram_ra1
  puts ""
}
